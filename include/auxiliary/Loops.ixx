...
template<long I1, long I2, long I3>
constexpr std::array<std::array<long, 3u>, I1 * I2 * I3> getIndices() {
    auto c = size_t { };
    auto indices = std::array<std::array<long, 3u>, I1 * I2 * I3> { };
    for (long i1 = 0; i1 != I1; ++i1) {
        for (long i2 = 0; i2 != I2; ++i2) {
            for (long i3 = 0; i3 != I3; ++i3, ++c) {
                indices[c] = { i1, i2, i3 };
            }
        }
    }
...
template<long I1, long I2>
constexpr std::array<std::array<long, 2u>, I1 * I2> getIndices() {
    auto c = size_t { };
    auto indices = std::array<std::array<long, 2u>, I1 * I2> { };
    for (long i1 = 0; i1 != I1; ++i1) {
        for (long i2 = 0; i2 != I2; ++i2, ++c) {
            indices[c] = { i1, i2 };
        }
    }
    return indices;
